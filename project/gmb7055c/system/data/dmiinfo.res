...
Handle 0x0040, DMI type 43, 31 bytes
TPM Device
	Vendor ID: CTNI
	Specification Version: 2.0	Firmware Revision: 402.1
	Description: INTEL	Characteristics:
		Family configurable via platform software support
	OEM-specific Information: 0x00000000

Handle 0x0041, DMI type 221, 12 bytes
OEM-specific Type
	Header and Data:
		DD 0C 41 00 01 01 00 02 00 00 BD 10
	Strings:
		BIOS Guard

Handle 0x0042, DMI type 221, 26 bytes
OEM-specific Type
	Header and Data:
		DD 1A 42 00 03 01 00 07 00 51 41 00 02 00 00 00
		00 AA 00 03 00 01 05 00 00 00
	Strings:
		Reference Code - CPU
		uCode Version
		TXT ACM version
...
OEM-specific Type
	Header and Data:
		DD 1A 43 00 03 01 00 07 00 51 41 00 02 00 0A 00
		00 01 00 03 04 0C 00 06 60 04
	Strings:
		Reference Code - ME
		MEBx version
		ME Firmware Version
...
Handle 0x0044, DMI type 221, 82 bytes
OEM-specific Type
	Header and Data:
		DD 52 44 00 0B 01 00 07 00 51 41 00 02 03 FF FF
...
OEM-specific Type
	Header and Data:
		DD 36 45 00 07 01 00 07 00 51 41 00 02 00 00 07
		01 5F 00 03 00 07 00 51 41 00 04 05 FF FF FF FF
...
Handle 0x0046, DMI type 221, 12 bytes
OEM-specific Type
	Header and Data:
		DD 0C 46 00 01 01 00 04 00 00 00 00
	Strings:
		FSP Binary Version
...
Handle 0x004C, DMI type 17, 84 bytes
Memory Device
	Array Handle: 0x003A
	Error Information Handle: Not Provided
	Total Width: Unknown
...
Handle 0x004D, DMI type 17, 84 bytes
Memory Device
	Array Handle: 0x003A
	Error Information Handle: Not Provided
	Total Width: 64 bits
	...
	Speed: 2400 MT/s
	Manufacturer: 06CE
	Serial Number: 01001714
	Asset Tag: 9876543210
	Part Number: AD4SSZ8GT6WB-FQGB   
	Rank: 2
	...
	Firmware Version: Not Specified
	Module Manufacturer ID: Bank 7, Hex 0xCE
	Module Product ID: Unknown
	Memory Subsystem Controller Manufacturer ID: Unknown
	Memory Subsystem Controller Product ID: Unknown
	Non-Volatile Size: None
...
OEM-specific Type
	Header and Data:
		82 14 50 00 24 41 4D 54 00 00 00 00 00 A5 AF 02
		C0 00 00 00

Handle 0x0051, DMI type 131, 64 bytes
OEM-specific Type
	Header and Data:
		83 40 51 00 35 00 00 00 0A 00 00 00 00 00 01 00
		F8 00 06 A3 00 00 00 00 01 00 00 00 00 00 0C 00
		60 04 06 00 00 00 00 00 FE 00 FF FF 00 00 00 00
...
Handle 0x0062, DMI type 221, 89 bytes
OEM-specific Type
	Header and Data:
		DD 59 62 00 0C 01 00 FF FF FF FF FF 02 00 FF FF
...
Handle 0x0063, DMI type 136, 6 bytes
OEM-specific Type
	Header and Data:
		88 06 63 00 00 00

Handle 0x0064, DMI type 14, 26 bytes
Group Associations
...
Handle 0x0065, DMI type 14, 8 bytes
Group Associations
	Name: $MEI
	Items: 1
		0x0000 (OEM-specific)

Handle 0x0066, DMI type 219, 106 bytes
OEM-specific Type
	Header and Data:
		DB 6A 66 00 01 04 01 55 02 00 90 06 01 10 80 20
		00 00 00 04 40 00 00 00 00 00 00 00 00 40 00 02

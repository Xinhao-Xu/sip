...
TEST_ACTION g_DiagAutoTest[] =
{
	...
	*/	
	...
	ITEM_MAP(T01020001),  //FAN1 cpu
	//ITEM_MAP(T01020002),  //FAN2
	//ITEM_MAP(T01020004),  //FAN3 side CN19
	//ITEM_MAP(T01023001),	//Sysytem RTC
...
{
	ITEM_MAP(T01005001),    //gold finger Audio test Package
	ITEM_MAP(T01005002),	//3.5mm

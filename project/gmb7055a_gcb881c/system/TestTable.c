...
TEST_ACTION g_DiagAutoTest[] =
{
	...
	*/	
	...
	//881c
	ITEM_MAP(T01020001),  //FAN1 sys gmb7055 //g_testargu.fan1_duty;
	//ITEM_MAP(T01020002),  //FAN2 left gmb7055, manual test
	ITEM_MAP(T01020003),  //FAN3 right gcb881c	//g_testargu.fan3_duty;
	ITEM_MAP(T01020004),  //FAN4 gcb881c  //use g_testargu.fan2_duty;
	//881c
	...
	ITEM_MAP(T02017029),  //
	ITEM_MAP(T02017030),  //
	ITEM_MAP(T02017031),  //DK 20160817 pci config table version check
	//881c
...
TEST_ACTION g_DiagManuTest[] =
{
	...
	//ITEM_MAP(T02013006),  	//Intrusion 3	
	//881c
	ITEM_MAP(T02022001),	//Fan LED gcb881c, need last test.
	//881c
	//total57
